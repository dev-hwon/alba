  ...
  <div class="activity-container">
    ...
    <div class="info-section">
      ...
      <div class="section-details">
        ...
        에도시대의 문화를 체험하는 <strong>지다이무라</strong>, <br />
        그리고 북해도 개척의 상징 <strong>홋츠지 가요 전망대</strong>까지.<br />
    ...
    <div class="info-section">
      ...
      <div class="section-details">
        ...
        활기 넘치는 먹거리 거리 <strong>오르골당</strong>,<br />
        그리고 감각적인 상점들이 이어진 <strong>사포로 시내</strong>까지.<br />
        역사와 감성, 그리고 홋카이도의 분위기를 <strong>천천히 걸으며 즐기는 매력적인 도시, 오타루</strong>입니다.
      </div>
    </div>
  </div>
</template>
